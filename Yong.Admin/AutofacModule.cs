...
namespace Yong.Admin
{
    public static class AutofacModule
    {
        ...
        public static IServiceCollection AddYongAdminModule(this IServiceCollection services)
        {
            
            Func<IServiceProvider, IFreeSql> fsqlFactory = r =>
            {
                IFreeSql fsql = new FreeSql.FreeSqlBuilder()
                    .UseConnectionString(FreeSql.DataType.MySql, @"Data Source=119.29.202.87;Port=3306;User ID=YongAdmin;Password=123456; Initial Catalog=YongAdmin;Charset=utf8; SslMode=none;Min pool size=5")
